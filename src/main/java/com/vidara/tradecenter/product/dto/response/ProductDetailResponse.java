...
public class ProductDetailResponse {
    ...
    public List<SpecificationResponse> getSpecifications() { return specifications; }
    public void setSpecifications(List<SpecificationResponse> specifications) { this.specifications = specifications; }
